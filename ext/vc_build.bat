...
SET PHP_5_5_BRANCH_TAG_VERSION=php-5.5.31
SET PHP_5_6_BRANCH_TAG_VERSION=php-5.6.17
SET PHP_7_0_BRANCH_TAG_VERSION=php-7.0.2
...
:BUILDMPIR [source-directory] [install-directory] [build-type] [target-architecture] [visual-studio-version] [log-filename]
  ...
  IF !MPIR_VISUAL_STUDIO_VERSION! EQU 2010 (
    XCOPY /Y !MPIR_VISUAL_STUDIO_SOLUTION_DIRECTORY!\lib_mpir_gc\!MPIR_PLATFORM_ARCHITECTURE!\!MPIR_BUILD_TYPE!\*.* "!MPIR_INSTALLATION_DIRECTORY!\lib" >> "!MPIR_LOG_FILENAME!" 2>&1
    IF NOT !ERRORLEVEL! EQU 0 (
      ECHO FAILED!
      ECHO 	See !MPIR_LOG_FILENAME! for more details
      RMDIR /S /Q "!MPIR_INSTALLATION_DIRECTORY!"
    ...
    XCOPY /Y !MPIR_VISUAL_STUDIO_SOLUTION_DIRECTORY!\!MPIR_PLATFORM_ARCHITECTURE!\!MPIR_BUILD_TYPE!\*.* "!MPIR_INSTALLATION_DIRECTORY!\lib" >> "!MPIR_LOG_FILENAME!" 2>&1
    IF NOT !ERRORLEVEL! EQU 0 (
      ECHO FAILED!
      ECHO 	See !MPIR_LOG_FILENAME! for more details
      RMDIR /S /Q "!MPIR_INSTALLATION_DIRECTORY!"
