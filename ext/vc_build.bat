...
SET CPP_DRIVER_REPOSITORY_URL=https://github.com/datastax/cpp-driver.git
SET CPP_DRIVER_DIRECTORY=cpp-driver
SET CPP_DRIVER_BRANCH_TAG_VERSION=2.0.0
...
SET "ABSOLUTE_DEPENDENCIES_CPP_DRIVER_SOURCE_DIRECTORY=%ABSOLUTE_BUILD_DIRECTORY%\%DEPENDENCIES_DIRECTORY%\%DEPENDENCIES_SOURCE_DIRECTORY%\%CPP_DRIVER_DIRECTORY%"
...
REM Clone cpp-driver and checkout the appropriate tag
IF NOT EXIST "!ABSOLUTE_DEPENDENCIES_CPP_DRIVER_SOURCE_DIRECTORY!" (
  ECHO | SET /P=Cloning cpp-driver ... 
  !GIT! clone !CPP_DRIVER_REPOSITORY_URL! "!ABSOLUTE_DEPENDENCIES_CPP_DRIVER_SOURCE_DIRECTORY!" > "!LOG_CPP_DRIVER_BUILD!" 2>&1
  IF !ERRORLEVEL! EQU 0 (
    ECHO done.
    PUSHD "!ABSOLUTE_DEPENDENCIES_CPP_DRIVER_SOURCE_DIRECTORY!" > NUL
    ECHO | SET /P=Checking out !CPP_DRIVER_BRANCH_TAG_VERSION! ... 
    ECHO. >> !LOG_CPP_DRIVER_BUILD!
    !GIT! checkout !CPP_DRIVER_BRANCH_TAG_VERSION! >> "!LOG_CPP_DRIVER_BUILD!" 2>&1
    IF !ERRORLEVEL! EQU 0 (
      ECHO done.
    ) ELSE (
      ECHO FAILED!
...
REM TODO: Move all of the driver building into its own batch function
  ECHO.
REM  ECHO Building PHP ... 
  PUSHD "!ABSOLUTE_DEPENDENCIES_PHP_SOURCE_DIRECTORY!" > NUL
REM  ECHO configure.bat --with-prefix="!ABSOLUTE_DEPENDENCIES_PHP_LIBRARIES_DIRECTORY!" --disable-all --enable-cli 
REM  CALL configure.bat --with-prefix="!ABSOLUTE_DEPENDENCIES_PHP_LIBRARIES_DIRECTORY!" --disable-all --enable-cli
REM  !NMAKE! install

  ECHO Building driver ... 
  CALL buildconf.bat --force --add-modules-dir="!ABSOLUTE_BATCH_DIRECTORY!\.."
  ECHO configure.bat --with-prefix="!ABSOLUTE_DRIVER_LIBRARY_DIRECTORY!" --disable-all --enable-cli --enable-cassandra=shared --with-cassandra-cpp-driver="!ABSOLUTE_DEPENDENCIES_CPP_DRIVER_LIBRARIES_DIRECTORY!" --with-libuv-libs="!ABSOLUTE_DEPENDENCIES_LIBUV_LIBRARIES_DIRECTORY!" --with-openssl-libs="!ABSOLUTE_DEPENDENCIES_OPENSSL_LIBRARIES_DIRECTORY!" --with-mpir="!ABSOLUTE_DEPENDENCIES_MPIR_LIBRARIES_DIRECTORY!"
  CALL configure.bat --with-prefix="!ABSOLUTE_DRIVER_LIBRARY_DIRECTORY!" --disable-all --enable-cli --enable-cassandra=shared --with-cassandra-cpp-driver="!ABSOLUTE_DEPENDENCIES_CPP_DRIVER_LIBRARIES_DIRECTORY!" --with-libuv-libs="!ABSOLUTE_DEPENDENCIES_LIBUV_LIBRARIES_DIRECTORY!" --with-openssl-libs="!ABSOLUTE_DEPENDENCIES_OPENSSL_LIBRARIES_DIRECTORY!" --with-mpir="!ABSOLUTE_DEPENDENCIES_MPIR_LIBRARIES_DIRECTORY!"
  !NMAKE! all install
  POPD
...
REM			REM Iterate through shared and static builds
REM			FOR %%D IN (!LIBRARY_TYPE_SHARED! !LIBRARY_TYPE_STATIC!) DO (
REM				REM Display summary of build options
REM				ECHO Building %%D Visual Studio !VISUAL_STUDIO_VERSION! Win%%C Package
REM
REM				REM Create the installation locations
REM				CALL :LOWERCASE %%D LOWECASE_LIBRARY_TYPE
REM				SET DEPENDENCY_PACKAGE_LIBUV_INSTALLATION_DIRECTORY=!DEPENDENCY_PACKAGE_INSTALLATION_DIRECTORY!\!LIBUV_DIRECTORY!\!LOWECASE_LIBRARY_TYPE!
REM				SET DEPENDENCY_PACKAGE_OPENSSL_INSTALLATION_DIRECTORY=!DEPENDENCY_PACKAGE_INSTALLATION_DIRECTORY!\!OPENSSL_DIRECTORY!\!LOWECASE_LIBRARY_TYPE!
REM				SET "ABSOLUTE_DEPENDENCY_PACKAGE_LIBUV_INSTALLATION_DIRECTORY=!ABSOLUTE_PACKAGES_DIRECTORY!\!DEPENDENCY_PACKAGE_LIBUV_INSTALLATION_DIRECTORY!"
REM				SET "ABSOLUTE_DEPENDENCY_PACKAGE_OPENSSL_INSTALLATION_DIRECTORY=!ABSOLUTE_PACKAGES_DIRECTORY!\!DEPENDENCY_PACKAGE_OPENSSL_INSTALLATION_DIRECTORY!"
REM
REM				REM Build the driver dependencies
REM				CALL :BUILDLIBUV "!ABSOLUTE_DEPENDENCIES_DIRECTORY!\!DEPENDENCIES_SOURCE_DIRECTORY!\!LIBUV_DIRECTORY!" "!ABSOLUTE_DEPENDENCY_PACKAGE_LIBUV_INSTALLATION_DIRECTORY!" %%C %%D !FALSE! !TRUE! "!LOG_LIBUV_BUILD!"
REM				IF !ERRORLEVEL! NEQ 0 EXIT /B !ERRORLEVEL!
REM				CALL :BUILDOPENSSL "!ABSOLUTE_DEPENDENCIES_DIRECTORY!\!DEPENDENCIES_SOURCE_DIRECTORY!\!OPENSSL_DIRECTORY!" "!ABSOLUTE_DEPENDENCY_PACKAGE_OPENSSL_INSTALLATION_DIRECTORY!" "" %%C %%D !TRUE! "!LOG_OPENSSL_BUILD!"
REM				IF !ERRORLEVEL! NEQ 0 EXIT /B !ERRORLEVEL!
REM
REM				REM Clean-up the dependency packages
REM				IF NOT EXIST "!ABSOLUTE_DEPENDENCY_PACKAGE_LIBUV_INSTALLATION_DIRECTORY!\..\!LIBRARY_INCLUDE_DIRECTORY!" MOVE /Y "!ABSOLUTE_DEPENDENCY_PACKAGE_LIBUV_INSTALLATION_DIRECTORY!\!LIBRARY_INCLUDE_DIRECTORY!" "!ABSOLUTE_DEPENDENCY_PACKAGE_LIBUV_INSTALLATION_DIRECTORY!\..\!LIBRARY_INCLUDE_DIRECTORY!" >> "!LOG_PACKAGE_BUILD!" 2>&1
REM				IF EXIST "!ABSOLUTE_DEPENDENCY_PACKAGE_LIBUV_INSTALLATION_DIRECTORY!\!LIBRARY_INCLUDE_DIRECTORY!" RMDIR /S /Q "!ABSOLUTE_DEPENDENCY_PACKAGE_LIBUV_INSTALLATION_DIRECTORY!\!LIBRARY_INCLUDE_DIRECTORY!" >> "!LOG_PACKAGE_BUILD!" 2>&1
REM				IF NOT EXIST "!ABSOLUTE_DEPENDENCY_PACKAGE_OPENSSL_INSTALLATION_DIRECTORY!\..\!LIBRARY_INCLUDE_DIRECTORY!" MOVE /Y "!ABSOLUTE_DEPENDENCY_PACKAGE_OPENSSL_INSTALLATION_DIRECTORY!\!LIBRARY_INCLUDE_DIRECTORY!" "!ABSOLUTE_DEPENDENCY_PACKAGE_OPENSSL_INSTALLATION_DIRECTORY!\..\!LIBRARY_INCLUDE_DIRECTORY!" >> "!LOG_PACKAGE_BUILD!" 2>&1
REM				IF NOT EXIST "!ABSOLUTE_DEPENDENCY_PACKAGE_OPENSSL_INSTALLATION_DIRECTORY!\openssl.cnf" MOVE /Y "!ABSOLUTE_DEPENDENCY_PACKAGE_OPENSSL_INSTALLATION_DIRECTORY!\openssl.cnf" "!ABSOLUTE_DEPENDENCY_PACKAGE_OPENSSL_INSTALLATION_DIRECTORY!" >> "!LOG_PACKAGE_BUILD!" 2>&1
REM				IF EXIST "!ABSOLUTE_DEPENDENCY_PACKAGE_OPENSSL_INSTALLATION_DIRECTORY!\!LIBRARY_INCLUDE_DIRECTORY!" RMDIR /S /Q "!ABSOLUTE_DEPENDENCY_PACKAGE_OPENSSL_INSTALLATION_DIRECTORY!\!LIBRARY_INCLUDE_DIRECTORY!" >> "!LOG_PACKAGE_BUILD!" 2>&1
REM				IF EXIST "!ABSOLUTE_DEPENDENCY_PACKAGE_OPENSSL_INSTALLATION_DIRECTORY!\openssl.cnf" ERASE /S /Q "!ABSOLUTE_DEPENDENCY_PACKAGE_OPENSSL_INSTALLATION_DIRECTORY!\openssl.cnf" >> "!LOG_PACKAGE_BUILD!" 2>&1
REM
REM				REM Copy distribution files into packages
REM				IF NOT EXIST "!ABSOLUTE_DEPENDENCY_PACKAGE_LIBUV_INSTALLATION_DIRECTORY!\..\LICENSE" COPY /Y "!ABSOLUTE_DEPENDENCIES_DIRECTORY!\!DEPENDENCIES_SOURCE_DIRECTORY!\!LIBUV_DIRECTORY!\LICENSE" "!ABSOLUTE_DEPENDENCY_PACKAGE_LIBUV_INSTALLATION_DIRECTORY!\.." >> "!LOG_PACKAGE_BUILD!" 2>&1
REM				IF NOT EXIST "!ABSOLUTE_DEPENDENCY_PACKAGE_OPENSSL_INSTALLATION_DIRECTORY!\..\LICENSE" COPY /Y "!ABSOLUTE_DEPENDENCIES_DIRECTORY!\!DEPENDENCIES_SOURCE_DIRECTORY!\!OPENSSL_DIRECTORY!\LICENSE" "!ABSOLUTE_DEPENDENCY_PACKAGE_OPENSSL_INSTALLATION_DIRECTORY!\.." >> "!LOG_PACKAGE_BUILD!" 2>&1
REM			)
...
REM @param install-dir Installation location of the cpp-driver
REM @param target-architecture 32 or 64-bit
...
:BUILDCPPDRIVER [source-directory] [target-compiler] [install-dir] [target-architecture] [enable-zlib] [use-boost-atomic] [log-filename]
...
REM @param install-dir Installation location of MPIR library
REM @param target-architecture 32 or 64-bit
REM @param log-filename Absolute path and filename for log output
:BUILDMPIR [source-directory] [install-dir] [target-architecture] [log-filename]
