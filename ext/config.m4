...
if test "$PHP_CASSANDRA" != "no"; then
  ...
  PHP_NEW_EXTENSION(cassandra, php_cassandra.c exceptions/exception.c exceptions/invalid_argument.c util/math.c types/bigint.c types/blob.c types/decimal.c types/timestamp.c types/varint.c, $ext_shared)
