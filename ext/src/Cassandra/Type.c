...
ZEND_BEGIN_ARG_INFO_EX(arginfo_type, 0, ZEND_RETURN_VALUE, 1)
  ZEND_ARG_OBJ_INFO(0, type, PHP_DRIVER_NAMESPACE_ARG\\Type, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_map, 0, ZEND_RETURN_VALUE, 2)
  ZEND_ARG_OBJ_INFO(0, keyType,   " PHP_DRIVER_NAMESPACE "\\Type, 0)
  ZEND_ARG_OBJ_INFO(0, valueType, PHP_DRIVER_NAMESPACE_ARG\\Type, 0)
ZEND_END_ARG_INFO()
